      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='relative mb-3'>
          <div className='flex flex-col md:flex-row gap-4'>
            ...
            <div className='w-full md:w-1/4 h-32 md:h-48'>
              <img src={formData.photo || '/path/to/default-image.jpg'} alt="User Photo" className='w-full object-cover rounded-sm' />
            </div>
          </div>
        </div>
        ...
        <div className='mb-4'>
          ...
          <p className='text-base font-serif'>
            ...
            I hereby declare that the particulars furnished in this application form are correct and true...
          </p>
        </div>
