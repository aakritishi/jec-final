  ...
  return (
    <>
      <div className=" flex flex-col items-center bg-green-500 ">
        <div className=" z-[-1] absolute top-[calc(85vh-15px)] bg-blue-500 sm:h-[180px] md:h-[150px] w-full max-w-[1100px] flex flex-wrap items-center justify-center gap-8 md:gap-[80px] rounded-[20px] p-4 md:p-0">
